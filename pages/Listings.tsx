...
import { Search, ArrowRight, Waves, Landmark, Castle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-brand-bg text-brand-primary pt-24 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {/* Collection 1 */}
              <div className="group relative h-[300px] md:h-[400px] overflow-hidden rounded-lg cursor-pointer">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 md:p-8 text-white">
                      ...
                      <p className="text-white/80 text-xs md:text-sm font-light leading-relaxed mb-4 md:mb-6 opacity-100 md:opacity-0 md:group-hover:opacity-100 transform md:translate-y-4 md:group-hover:translate-y-0 transition-all duration-500">
                      ...
                      <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest border-b border-white pb-1">View Collection</span>
                  </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-4 lg:gap-6 items-start lg:items-center justify-between">
            <div className="relative w-full lg:w-96 group">
              <input
                ...
                className="w-full bg-white border border-brand-border text-brand-primary text-sm px-4 py-3 pl-10 rounded-full focus:outline-none focus:border-brand-accent transition-all placeholder:text-brand-secondary/50 shadow-sm"
              />
